...
#SBATCH --output=outputs/test/parse_then_hop/output_parse_then_hop_hyperbolic_%j.txt
#SBATCH --error=outputs/test/parse_then_hop/error_parse_then_hop_hyperbolic_%j.txt
