...
#SBATCH --output=outputs/output_random_walk_training_adapt_bsize64_c4_hyperbolic_part1_%j.txt
#SBATCH --error=outputs/error_random_walk_training_adapt_bsize64_c4_hyperbolic_part1_%j.txt
